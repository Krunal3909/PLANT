...
Original file is located at
    https://colab.research.google.com/drive/1NkgxQ5URYP2TqZSy0iZSmZwFtfTS8SF4
"""
...
data_dir = '/content/drive/MyDrive/FarmEasy/DATA/PlantData'
...
model.save('/content/drive/MyDrive/FarmEasy/Model/PlantModelDenseNet.h5')
...
img = image.load_img('/content/drive/MyDrive/FarmEasy/DATA/PlantData/Potato___Early_blight/001187a0-57ab-4329-baff-e7246a9edeb0___RS_Early.B 8178.JPG', grayscale=False, target_size=(64, 64))
show_img=image.load_img('/content/drive/MyDrive/FarmEasy/DATA/PlantData/Potato___Early_blight/001187a0-57ab-4329-baff-e7246a9edeb0___RS_Early.B 8178.JPG', grayscale=False, target_size=(200, 200))
